...
public class JcsEcdsaSecp256k1Signature2019SignatureSuite extends SignatureSuite {
	...
	JcsEcdsaSecp256k1Signature2019SignatureSuite() {
		...
		super(
				...
				Arrays.asList(URI.create("https://www.w3.org/2018/credentials/v1"),URI.create("https://www.w3.org/2018/credentials/v1"),LDSecurityContexts.JSONLD_CONTEXT_W3ID_SUITES_SECP256K1_2019_V1));
	}
}
