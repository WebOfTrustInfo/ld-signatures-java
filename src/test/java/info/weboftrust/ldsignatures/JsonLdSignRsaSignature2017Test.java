...
public class JsonLdSignRsaSignature2017Test extends TestCase {
	...
	public void testSignEd25519Signature2018() throws Exception {
		...
		LinkedHashMap<String, Object> jsonLdObject = (LinkedHashMap<String, Object>) JsonUtils.fromInputStream(JsonLdSignRsaSignature2017Test.class.getResourceAsStream("input.jsonld"));
