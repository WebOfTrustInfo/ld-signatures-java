...
public class JsonLdSignJcsEd25519Signature2020Test {
	...
	public void testSign() throws Throwable {
		...
		JsonLDObject jsonLdObject = JsonLDObject.fromJson(new InputStreamReader(JsonLdSignJcsEd25519Signature2020Test.class.getResourceAsStream("input.jsonld")));
		...
		assertEquals("3L4Z6aCb9unrQzsYHywxwK8hFTB2RuVFwd8tbPRbFuyr3rmFxvNAFTAgD1YY9NmYfGynaci3iL43JVzrARPEiqHi", ldProof.getJsonObject().get("signatureValue"));
