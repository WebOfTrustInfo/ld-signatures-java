...
public class LdVerifiersTest {
	...
	public void testLdVerifiers() throws Exception {
		...
		assertEquals(LdVerifier.ldVerifierForSignatureSuite("JcsEd25519Signature2020").getClass(), JcsEd25519Signature2020LdVerifier.class);
		...
		assertEquals(LdVerifier.ldVerifierForSignatureSuite("JcsEcdsaSecp256k1Signature2019").getClass(), JcsEcdsaSecp256k1Signature2019LdVerifier.class);
