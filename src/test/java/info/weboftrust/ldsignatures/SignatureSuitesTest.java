...
public class SignatureSuitesTest {
	...
	public void testSignatureSuites() throws Exception {
		...
		assertEquals(SignatureSuites.findSignatureSuitesByKeyTypeName(KeyTypeName.BLS12381_G2).size(), 1);
		...
		assertTrue(SignatureSuites.findSignatureSuitesByKeyTypeName(KeyTypeName.BLS12381_G1).contains(SignatureSuites.SIGNATURE_SUITE_BBSBLSSIGNATURE2020));
		assertTrue(SignatureSuites.findSignatureSuitesByKeyTypeName(KeyTypeName.BLS12381_G2).contains(SignatureSuites.SIGNATURE_SUITE_BBSBLSSIGNATURE2020));
	}
}
